...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes_dict:
        ...
        txt_file.write(county_vote_results)
         ...
         ## need to check both?  they're kind of the same    
        if (county_votes > largest_county_turnout_votes):
            largest_county_turnout_name = county_name
            largest_county_turnout_votes = county_votes
        
    # 7: Print the county with the largest turnout to the terminal.
    largest_county_turnout_name_results = (
        f"\n---------------------------------\n"
        f"Largest County Turnout: {largest_county_turnout_name}\n"
        f"---------------------------------\n")

    print(largest_county_turnout_name_results)

    # # 8: Save the county with the largest turnout to a text file.
    txt_file.write(largest_county_turnout_name_results)
